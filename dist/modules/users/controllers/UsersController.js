...
var ListUserByIdService_1 = __importDefault(require("../services/ListUserByIdService"));
var UsersController = /** @class */ (function () {
    ...
    UsersController.prototype.find = function (request, response) {
        return __awaiter(this, void 0, void 0, function () {
            var id, userFind, user;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        id = request.params.id;
                        userFind = new ListUserByIdService_1.default();
                        return [4 /*yield*/, userFind.execute({ id: id })];
                    case 1:
                        user = _a.sent();
            ...
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, updateUser.execute({ id: id, name: name, email: email, password: password })];
                    case 1:
                        user = _b.sent();
                        return [2 /*return*/, response.json(user)];
                }
