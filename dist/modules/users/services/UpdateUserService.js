...
var UpdatePostService = /** @class */ (function () {
    function UpdatePostService() {
    }
    UpdatePostService.prototype.execute = function (_a) {
        var id = _a.id, name = _a.name, email = _a.email, password = _a.password;
        return __awaiter(this, void 0, void 0, function () {
            var usersRepository, user, checkUserExists;
                ...
                switch (_b.label) {
                    ...
                    case 2:
                        ...
                        if (checkUserExists && checkUserExists.id !== user.id) {
                            throw new AppError_1.default('This email is already used');
                        }
                        user.name = name;
                        user.email = email;
