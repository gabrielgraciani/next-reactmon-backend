...
var DeletePokemonService = /** @class */ (function () {
    function DeletePokemonService() {
    }
    DeletePokemonService.prototype.execute = function (_a) {
        var id = _a.id;
        return __awaiter(this, void 0, void 0, function () {
            var pokemonsRepository, pokemon, pokemonImageFilePath, pokemonImageFileExists;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 2:
                        pokemonImageFileExists = _b.sent();
                        if (!pokemonImageFileExists) return [3 /*break*/, 4];
                        return [4 /*yield*/, fs_1.default.promises.unlink(pokemonImageFilePath)];
                    case 3:
                        _b.sent();
                        _b.label = 4;
                    case 4: return [4 /*yield*/, pokemonsRepository.delete({ id: parseInt(id, 10) })];
                    case 5:
                        _b.sent();
                        return [2 /*return*/];
                }
...
exports.default = DeletePokemonService;
